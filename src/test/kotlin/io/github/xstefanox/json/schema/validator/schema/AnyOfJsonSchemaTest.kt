...
internal class AnyOfJsonSchemaTest {

    @Test
    @DisplayName("value should be accepted if it does conform to at least one of the nested schema")
    internal fun test1() {
    ...
    @Test
    @DisplayName("value should be accepted if it does conform to more than one of the nested schema")
    internal fun test3() {
